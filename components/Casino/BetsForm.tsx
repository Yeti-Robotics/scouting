...
import { Box, Button, Card, Checkbox, Input, Overlay, Stack, Title } from '@mantine/core';
		...
		<>
			...
			>
				<Card withBorder shadow='md'>
					{notBetting.winner && <Overlay zIndex={1} />}
					<Stack align='center'>
						<Title order={1}>Who Wins</Title>
						<Title order={2}>
				...
				<Card withBorder shadow='md'>
					{notBetting.topScorer && <Overlay zIndex={1} />}
					<Stack align='center'>
						<Title order={1}>Who Scores The Most</Title>
						<Title order={2}>
							Pick which alliance you think will win and how much you want to bet.
						</Title>
				...
				<Card withBorder shadow='md'>
					{notBetting.bottomScorer && <Overlay zIndex={1} />}
					<Stack align='center'>
						<Title order={1}>Who Scores The Most</Title>
						<Title order={2}>
							Pick which alliance you think will win and how much you want to bet.
