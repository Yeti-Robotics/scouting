...
const ScoutErrorTable = ({ data }: TableScrollAreaProps) => {
	...
	return (
		<ScrollArea
			...
			w='100%'
		>
			<Table cellSpacing={0} striped highlightOnHover w='100%'>
					...
					{table.getHeaderGroups().map((headerGroup) => (
						<tr key={headerGroup.id}>
							{headerGroup.headers.map((header) => (
								...
								>
									<Group spacing='xs' position='left' align='left'>
...
export default ScoutErrorTable;
